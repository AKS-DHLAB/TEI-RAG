...
<xsl:transform xmlns:error="https://doi.org/10.5281/zenodo.1495494#error"
   ...
   <rdf:Description xmlns:dc="http://purl.org/dc/elements/1.1/"
      ...
      <dct:created>2025-09-04T16:13:44.932889333Z</dct:created>
   </rdf:Description>
   ...
   <xsl:template name="d12e32">
      <schxslt:document>
         ...
         <schxslt:pattern id="d12e83">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    name="schematron-constraint-subtypeTyped-6"
                                    id="schematron-constraint-subtypeTyped-6">
                  <xsl:attribute name="documents" select="base-uri(.)"/>
               </svrl:active-pattern>
            </xsl:for-each>
         </schxslt:pattern>
         <schxslt:pattern id="d12e95">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    name="schematron-constraint-abstractModel-structure-p-in-ab-or-p-7"
                                    id="schematron-constraint-abstractModel-structure-p-in-ab-or-p-7">
                  <xsl:attribute name="documents" select="base-uri(.)"/>
               </svrl:active-pattern>
            </xsl:for-each>
         </schxslt:pattern>
         <schxslt:pattern id="d12e104">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    name="schematron-constraint-abstractModel-structure-p-in-l-8"
                                    id="schematron-constraint-abstractModel-structure-p-in-l-8">
                  <xsl:attribute name="documents" select="base-uri(.)"/>
               </svrl:active-pattern>
            </xsl:for-each>
         </schxslt:pattern>
   ...
   <xsl:template match="tei:*[@generatedBy]" priority="7" mode="d12e32">
   ...
   <xsl:template match="tei:*[@when]" priority="6" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@from]" priority="5" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@to]" priority="4" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@source]" priority="3" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
   ...
   <xsl:template match="tei:*[@subtype]" priority="2" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:p" priority="1" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:l//tei:p" priority="0" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
