...
<xsl:transform xmlns:error="https://doi.org/10.5281/zenodo.1495494#error"
   ...
   <rdf:Description xmlns:dc="http://purl.org/dc/elements/1.1/"
      ...
      <dct:created>2025-09-04T16:15:20.440202782Z</dct:created>
   </rdf:Description>
   ...
   <xsl:template match="tei:*[@generatedBy]" priority="28" mode="d12e32">
   ...
   <xsl:template match="tei:*[@when]" priority="27" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@from]" priority="26" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@to]" priority="25" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@source]" priority="24" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
   ...
   <xsl:template match="tei:*[@unitRef]" priority="23" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@schemeVersion]" priority="20" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@subtype]" priority="19" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:*[@calendar]" priority="18" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:p" priority="17" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:l//tei:p" priority="16" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:rt/@target" priority="14" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:rt/@from" priority="13" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:rt/@to" priority="12" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:ptr" priority="11" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:ref" priority="10" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:list[@type='gloss']" priority="9" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:relatedItem" priority="8" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:l" priority="7" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:lg" priority="6" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:lg" priority="5" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:quotation" priority="4" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:l//tei:div" priority="1" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
   ...
   <xsl:template match="tei:div" priority="0" mode="d12e32">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
